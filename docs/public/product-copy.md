...
analytics with guided setup in the web dashboard.

## Value (3 bullets)

- **Rosters:** coaches create/manage rosters; staff review and approve submissions.
- **Recruiting:** structured player profiles + searchable player pool, backed by web workflows.
...
- **Staff & moderators:** need review, auditability, and reliable player visibility.
...
| --- | --- | --- |
| Dashboards + Setup Wizard | owners + staff | guided setup checks and web dashboard workflows |
| Rosters | coaches + staff | roster lifecycle: create, add/remove, caps, submit, review, approve/reject/unlock |
| Recruiting | staff | recruit profiles + player pool search; availability workflows |
| Clubs | managers + staff | club ads, club manager workflows and reporting |
...
- `premium_coach_tiers` (Coach+/Club Manager/Club Manager+ roles and expanded roster caps)
